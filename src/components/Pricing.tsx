...
const PLANS: Plan[] = [
  {
    ...
    name: "Starter",
    price: "$49",
    tagline: "For small brands starting partner discovery.",
    features: [
      "10 competitor scans / month",
      "Up to 50 partner results / month",
      "Evidence-backed partner discovery",
      "Promo code & partner signal detection",
  ...
  },
  {
    ...
    name: "Growth",
    price: "$99",
    tagline: "For growing e-commerce brands actively recruiting partners.",
    features: [
      "50 competitor scans / month",
      "Up to 300 partner results / month",
  ...
  },
  {
    ...
    name: "Pro",
    price: "$199",
    tagline: "For brands and teams running partner acquisition at scale.",
    features: [
      "150 competitor scans / month",
      "Up to 1,000 partner results / month",
